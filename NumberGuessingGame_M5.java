...
// Number Guessing Game: This program asks the user to guess a number from 1-100. The program displays if guess is higher or lower if incorrect, and the number of tries.
